...
extra_args = --quiet --noinclude-qt-translations --include-data-files=draftomen/baseline_profiles/hob-quickdraft.json=draftomen/baseline_profiles/hob-quickdraft.json --company-name="Draft Omen" --product-name="Draft Omen" --file-version=0.3.1 --product-version=0.3.1 --macos-app-name="Draft Omen" --macos-app-version=0.3.1 --macos-signed-app-name=io.github.andreagrandi.draftomen --include-package=socketio
macos.permissions =
