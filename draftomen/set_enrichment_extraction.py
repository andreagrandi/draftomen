...
_CARD_CAPABILITY_SYSTEM_PROMPT = (
    ...
    " A static ability is a capability of its own and is never replaced by a keyword ability in the "
    "same Oracle text: an anthem that gives your creatures +1/+1, or a static creature-count value "
    "such as a power equal to the number of creatures you control, is a go-wide payoff "
    "(go_wide_payoff), and it is extracted in addition to every keyword-ability capability the same "
    "Oracle text states."
